 ...
 * @property responses   responseCode → ResponseInfo 맵. 비어있으면 기본값 "200" → "OK"가 들어간다.
...
data class OperationInfo(
    ...
    val requestBody: RequestBodyInfo? = null,
    val responses: Map<String, ResponseInfo>,
    val security: List<SecurityRequirementInfo> = emptyList(),
